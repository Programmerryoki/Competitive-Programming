# A_search_longest try to catch as many inf as it can + margin
...
def main():
    ...
    for case in range(1000):
        ...
        if case < 90:
            ans = search_longest((sik,sjk), (tik,tjk))
        elif case < 290:
            ans = search_midest((sik,sjk), (tik,tjk))
        else:
            ans = search_shortest((sik,sjk), (tik,tjk))
