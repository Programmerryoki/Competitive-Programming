...
def main():
    ...
    for case in range(1000):
        ...
        percent = []
        percent.append(max(1, int(-0.01*case**2+99)))
        percent.append(max(10, int(-0.0008*(case - 300)**2 + 95)))
        rint = randint(1,100)
        if rint < percent[0]:
            ans = search_longest(15, (sik,sjk), (tik,tjk))
        elif rint < sum(percent):
            ans = search_midest(5,(sik,sjk), (tik,tjk))
        else:
            ans = search_shortest(10,(sik,sjk), (tik,tjk))
